    ...
    fun addTourist(tourist: Tourist, context: Context) {
        ...
        db.collection("Tourists")
            ...
            .addOnSuccessListener {
                ...
                Toast.makeText(context, "Tourist uploaded successfully!", Toast.LENGTH_SHORT).show()
            }
            ...
            .addOnSuccessListener { querySnapshot ->
                for (document in querySnapshot.documents) {
                    document.reference.delete().addOnSuccessListener {
                        ...
                        Toast.makeText(context, "Tourist deleted successfully!", Toast.LENGTH_SHORT).show()
                    }.addOnFailureListener {
            ...
            .addOnSuccessListener { querySnapshot ->
                for (document in querySnapshot.documents) {
                    ...
                    document.reference.update(updates as Map<String,Any>)
                        .addOnSuccessListener {
                            Toast.makeText(context, "Mot de passe modifié avec succés!", Toast.LENGTH_SHORT).show()
                        }
                        .addOnFailureListener { e ->
                            Log.e(TAG, "échec du modification du mot de passe: $e")
                            Toast.makeText(context, "échec du modification du mot de passe!", Toast.LENGTH_SHORT).show()
                        }
                }
            }
            .addOnFailureListener {
