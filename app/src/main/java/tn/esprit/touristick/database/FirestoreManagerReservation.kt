    ...
    fun addReservation(reservation: Reservation, context: Context) {
        ...
        db.collection("Reservations")
            ...
            .addOnSuccessListener {
                ...
                Toast.makeText(context, "Reservation uploaded successfully!", Toast.LENGTH_SHORT).show()
            }
            .addOnFailureListener { e ->
                Log.e(TAG, "Error adding reservation: $e")
                Toast.makeText(context, "Failed to upload reservation!", Toast.LENGTH_SHORT).show()
            }
    }
